...
public class PaymentWebhookController {
    ...
    @PostMapping()
    public ResponseEntity<String> sendPaymentApprove(@RequestBody SendPaymentApproveRequest sendPaymentApproveRequest) {
        editOrderPaymentStatus.editOrderPaymentStatus(sendPaymentApproveRequest.orderId(),
                sendPaymentApproveRequest.paymentStatus());
